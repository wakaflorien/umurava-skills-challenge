                            ...
                            <div className='sm:space-y-8'>
                                ...
                                <div className="flex sm:flex-row sm:gap-4">
                                    <div className="relative bg-tertiaryColor h-8 w-8 rounded-full border-2 border-white">
                                        <Image src="/.Sidebar/Image.png" alt="avatar" objectFit='cover' priority className="rounded-full" width={32} height={32} />
                                        <div className='absolute bottom-0 right-0 bg-success h-2 w-2 border border-white rounded-full'></div>
                                    </div>
                                    ...
                                    <Signout className={`h-4 w-4 !stroke-current cursor-pointer`} onClick={() => console.log("Logout clicked")} />
                                </div>
                            </div>
                        </nav>
                    </aside>
